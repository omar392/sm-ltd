                        ...
                        <div class="card-body">
                            <form action="" id="abouts" method="POST" data-parsley-validate>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                     <textarea class="form-control"  name="mission_ar" id="editor3" cols="10" rows="10">{!! $about->mission_ar !!}</textarea>
                                        <script>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                     <textarea class="form-control"  name="mission_en" id="editor4" cols="10" rows="10">{!! $about->mission_en !!}</textarea>
                                        <script>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                     <textarea class="form-control"  name="vision_ar" id="editor5" cols="10" rows="10">{!! $about->vision_ar !!}</textarea>
                                                 <script>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                     <textarea class="form-control"  name="vision_en" id="editor6" cols="10" rows="10">{!! $about->vision_en !!}</textarea>
                                                 <script>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                     <textarea class="form-control"  name="about_ar" id="editor7" cols="10" rows="10">{!! $about->about_ar !!}</textarea>
                                        <script>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                     <textarea class="form-control"  name="about_en" id="editor8" cols="10" rows="10">{!! $about->about_en !!}</textarea>
                                        <script>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                     <textarea class="form-control"  name="goals_ar" id="editor1" cols="10" rows="10">{!! $about->goals_ar !!}</textarea>
                                         <script>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                     <textarea class="form-control"  name="goals_en" id="editor2" cols="10" rows="10">{!! $about->goals_en !!}</textarea>
                                        <script>
