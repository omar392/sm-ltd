            ...
            <div class="slimscroll-menu" id="remove-scroll">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        @endif
                        @if(Auth::guard('admin')->user()->hasPermission('fasts-read'))
                        <li>
                            <a href="{{ route('fasts.index') }}" class="waves-effect">
                                <i class="fas fa-newspaper"></i><span class="badge badge-success badge-pill float-right"></span> <span> {{ __('admin.fasts') }} </span>
                            </a>
                        </li>
                        @endif
                        ...
                        <li>
                            <a href="{{route('counters.index')}}" class="waves-effect">
                                <i class="fas fa-cog"></i><span>{{ __('admin.counter') }}</span>
                            </a>
                        </li>
                        @endif
