                    ...
                    <div class="card m-b-30">
                        <div class="card-body">
                            <form action="" id="settings" method="POST" data-parsley-validate>
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input"
                                        class="col-sm-2 col-form-label">Wahtsapp</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" value="{{ $setting->whatsapp }}"
                                            name="whatsapp" id="example-text-input"
                                            placeholder="Wahtsapp" required parsley-trigger="change" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" value="{{ $setting->youtube }}"
                                            name="youtube" id="example-text-input"
                                            placeholder="Youtube" required parsley-trigger="change" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input"
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input"
                                        class="col-sm-2 col-form-label">Video URL</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" value="{{ $setting->video }}"
                                            name="video" id="example-text-input"
                                            placeholder="Video URL" required parsley-trigger="change" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input"
