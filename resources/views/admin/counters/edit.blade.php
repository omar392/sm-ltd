                    ...
                    <div class="card m-b-30">
                        <div class="card-body">
                            <form action="" id="counters" method="POST" data-parsley-validate>
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input"
                                        class="col-sm-2 col-form-label">{{ __('admin.input4') }}</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" value="{{ $counter->input4 }}" type="text"
                                            name="input4" id="example-text-input"
                                            placeholder="{{ __('admin.input4') }} " parsley-trigger="change" >
                                            <span class="text-danger" id="input4Error"></span>
                                    </div>
                                </div>
